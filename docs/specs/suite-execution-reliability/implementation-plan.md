...
- `docs/specs/suite-execution-reliability/suite-execution-reliability-spec.md`
...
- existing files under `docs/specs/design-motion-refinement/`
...
- Modify: `docs/specs/suite-execution-reliability/suite-execution-reliability-spec.md` only for factual shipped-state corrections
- Modify: `docs/specs/suite-execution-reliability/implementation-plan.md` only for factual command/path corrections
...
git diff -- server src scripts package.json docs/qa/suite-execution-reliability \
  docs/specs/suite-execution-reliability
```
