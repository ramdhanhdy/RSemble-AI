...
- `docs/specs/executed/suite-execution-reliability/suite-execution-reliability-spec.md`
...
- existing files under `docs/specs/executed/design-motion-refinement/`
...
- Modify: `docs/specs/executed/suite-execution-reliability/suite-execution-reliability-spec.md` only for factual shipped-state corrections
- Modify: `docs/specs/executed/suite-execution-reliability/implementation-plan.md` only for factual command/path corrections
...
git diff -- server src scripts package.json docs/qa/suite-execution-reliability \
  docs/specs/executed/suite-execution-reliability
```
