...
// removed; only the allowlisted in-memory substrate (`InMemoryFusionStudyRepository`)
// remains, consumed by the Policy Study adapter behind canonical Lab authority.
// These tests exercise the in-memory repository: versioned recipe/manifest
// immutability, study revision guards, the sealTrial anti-circularity check,
// trial-attempt linkage rules, and observation attach semantics (spec required
// tests 1, 2, and 9).
// =============================================================================
...
describe("InMemoryFusionStudyRepository", () => {
  function makeRepo(): FusionStudyRepository & object {
    return new InMemoryFusionStudyRepository();
  }
