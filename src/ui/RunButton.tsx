...
export function RunButton({
  ...
  return (
    <button
      ...
      className="mt-auto inline-flex min-h-[44px] items-center justify-center gap-2 rounded-md bg-cyan-500 px-4 py-2.5 text-sm font-semibold text-zinc-950 transition-colors hover:bg-cyan-400 focus-visible:outline focus-visible-2 focus-visible:outline-cyan-400 disabled:cursor-not-allowed disabled:bg-zinc-800 disabled:text-zinc-500"
    >
